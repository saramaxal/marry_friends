export const configs = {
    ...
    scheduleData: {
        ...
        3 : {
            ...
            description: "Вы сможете насладиться сочными фруктами в непринуждённой атмосфере.",
            image: "./image/1200.png"
        },
        4 : {
            time: "16:00",
            title: "Вегетарианский банкет",
            description: "На банкете в ресторане «Мансард» вас ждет разнообразие вкусных блюд и увлекательные развлечения в компании близких и друзей.",
